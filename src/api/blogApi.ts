...
export const updateArticle      = (article:ChangedArticle,aid:number)       => request.put(`${prefix}/${aid}`,article)
export const deleteArticle      = (aid:number)                              => request.delete(`${prefix}/${aid}`)
